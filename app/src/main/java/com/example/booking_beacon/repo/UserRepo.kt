...
class UserRepo {
    ...
    suspend fun registerPartnerUser(registerPartnerUser: RegisterPartnerUserData): String {
        return KtorClient.httpClient.post("$baseUrl/join-partner") {
            contentType(io.ktor.http.ContentType.Application.Json)
            body = registerPartnerUser
        }
    }
